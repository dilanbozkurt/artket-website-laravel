...
<head>
  ...
  <body style="background-image:url('../red-green-background.jpg')">
    ...
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col-md-12">
            <form id="regForm" action="{{ route('create_post', ['type' => 'video'])}}" method="post" enctype="multipart/form-data">
                @csrf
                <h1 id="register">CREATE A VIDEO POST</h1>
                    ...
                    justify-content:center;">
                        ...
                        box-shadow: -3px -3px 7px rgba(94, 104, 121, 0.377),
                            ...
                            <div class="video_preview">
                                <video width="400" height="200" id="video-file-ip-1-preview" style="  width:100%;
                                display:none;
                            ...
                            <p><p><input type="file" name="videoToUpload" id="videoToUpload" oninput="this.className = ''" accept="video/*" onchange="showVideoPreview(event);"></p></p>
                        </div>
                    </div>
                </div>
