...
<head>
  ...
  <body style="background-image:url('../red-green-background.jpg')">
    ...
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col-md-12">
            <form id="regForm" action="{{ route('create_post', ['type' => 'audio'])}}" method="post" enctype="multipart/form-data">
                @csrf
                <h1 id="register">CREATE AN AUDIO POST</h1>
                <div class="all-steps" id="all-steps">  <span class="step"><i class="fa fa-header"></i></span> <span class="step"><i class="fa fa-align-justify"></i></span> <span class="step"><i class="fa fa-picture-o"></i></span><span class="step"><i class="fa fa-video-camera"></i></span>
                    ...
                    justify-content:center;">
                        ...
                        box-shadow: -3px -3px 7px rgba(94, 104, 121, 0.377),
                            ...
                            <div class="audio_preview">
                                <audio width="400" id="audio-file-ip-1-preview" style="  width:100%;
                                display:none;
                                margin-bottom:30px;" controls>
                                    <source type="audio/mp3">
                                </video>
                                {{-- <img id="video-file-ip-1-preview" style="  width:100%;
                                display:none;
                                margin-bottom:30px;"> --}}
                            </div>
                            <h6>Select the audio</h6>
                            <p><p><input type="file" name="audioToUpload" id="audioToUpload" oninput="this.className = ''" accept="audio/*" onchange="showAudioPreview(event);"></p></p>
                        </div>
                    </div>
                </div>
